...
function renderStep1() {
  ...
  return `
    ...
    <!-- Аватарка -->
    <div class="avatar-section fade-in-up delay-1" style="margin-top: var(--space-5);">
      <div class="avatar avatar-lg" id="avatar-upload">
        АИ
      </div>
    ...
    <div class="input-group fade-in-up delay-2">
      ...
      <input type="text" class="input" id="onboard-name" name="name" autocomplete="name" value="Анна Иванова" placeholder="Ваше имя">
    </div>
    ...
    <div class="input-group fade-in-up delay-4">
      <label class="input-label" for="onboard-experience">Опыт работы (необязательно)</label>
      <input type="text" class="input" id="onboard-experience" name="experience" autocomplete="off" placeholder="Например: 5 лет">
    </div>
